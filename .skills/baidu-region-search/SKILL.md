...
| 属性 | 值 |
|------|---|
| Endpoint | `GET https://app-dm7baw05jabl-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-dm7baw05jabl-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/?${params.toString()}`,
    {
      method: "GET",
      headers: {
