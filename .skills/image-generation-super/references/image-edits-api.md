...
| Endpoint | `POST https://app-dm7baw05jabl-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2`       |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "https://app-dm7baw05jabl-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2",
    {
      method: "POST",
      headers: {
