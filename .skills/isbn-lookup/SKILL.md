...
- **Endpoint**：`POST https://app-dm7baw05jabl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 调用上游接口 ---
  const url = new URL("https://app-dm7baw05jabl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
