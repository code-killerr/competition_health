...
- **Endpoint**：`POST https://app-dm7baw05jabl-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-dm7baw05jabl-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
