...
| [lab-automation.md](lab-automation.md) | the experimental laboratory automation capabilities: knowledge, planning, Skills, devices, Runtime, and Web snapshot composition |
