...
English | [中文](lab-automation.zh.md)

The experimental laboratory automation subsystem provides opt-in Service Definitions and local Providers for knowledge ingestion, plan and Skill review, controlled device execution, result validation, and a read-only Web snapshot. It reuses the Harness Agent, tool, Skill, approval, Session, Storage, and subprocess capabilities; it does not modify the Agent Loop or the default profile.

The package contracts are owned by the experimental package READMEs: [domain](../../packages/experimental/lab-domain/README.md), [knowledge](../../packages/experimental/lab-knowledge/README.md), [planning](../../packages/experimental/lab-planning/README.md), [Skill](../../packages/experimental/lab-skill/README.md), [device](../../packages/experimental/lab-device/README.md), [Runtime](../../packages/experimental/lab-runtime/README.md), and [Web](../../packages/experimental/lab-mvp-web/README.md). The first-round composition and scope are recorded in the development plan.
