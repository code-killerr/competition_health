...
export const zh = {
  ...
  'agentDock.timeline': '查看 Agent 执行时间线',
  'agentDock.timelineOpen': '收起 Agent 执行时间线',
  'input.commands': '命令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
...
export const en = {
  ...
  'agentDock.timeline': 'View Agent execution timeline',
  'agentDock.timelineOpen': 'Collapse Agent execution timeline',
