          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <span className={css.labweaveMark}>LW</span> })}
              </span>
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: (
                    <>
                      <span className={css.fallbackBrandName}>LABWEAVE</span>
                      <span className={css.brandSubtitle}>AI 实验工作台</span>
                    </>
                  ),
                })}
              </span>
