...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: '根应用页面；可选择替换、并列或底部 Agent dock 对话。',
    doc: '根应用页面；可选择替换、并列或底部 Agent dock 对话。',
    registerOptions: [
      {
        name: 'id',
    ...
    occupants: [
      ...
      'client-ui-lab-workbench LabDevicesView id \'lab-devices\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'app.view\', () => ctx.slots.register(\n      { name: \'app.view\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-lab-workbench LabCommandCard',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, lab-lifecycle, manual-compaction, model-retry, steering, tool-call, turn-error, turn-max-tokens, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      ...
      'client-ui-lab-workbench LabLifecycleNodeView key \'lab-lifecycle\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-lab-workbench LabConversationHeaderAction id \'lab-context-action\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'New Session 与 Workspace 浏览区之间的根级一级导航。',
    doc: 'New Session 与 Workspace 浏览区之间的根级一级导航。',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-lab-workbench LabGlobalNavigation id \'lab-global-navigation\'',
    ],
    replaceRisk: 'none',
