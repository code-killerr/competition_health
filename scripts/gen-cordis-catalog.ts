...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  jobs: 'jobs.md',
  labDevices: 'lab-automation.md',
  labExperimentCache: 'lab-automation.md',
  labKnowledge: 'lab-automation.md',
  labMvpWeb: 'lab-automation.md',
  labPlanning: 'lab-automation.md',
  labProjects: 'lab-automation.md',
  labRuntime: 'lab-automation.md',
  labSkills: 'lab-automation.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ExperimentCacheProjection: 'lab-automation.md',
  ExperimentCacheStore: 'lab-automation.md',
  CreateSopDraftRequest: 'lab-automation.md',
  SopDraftResult: 'lab-automation.md',
  KnowledgeSopDraftId: 'lab-automation.md',
  UpdateSopDraftRequest: 'lab-automation.md',
  PublishSopDraftRequest: 'lab-automation.md',
  LabWebCommand: 'lab-automation.md',
  LabWebCommandResult: 'lab-automation.md',
  LabProjectConversationCommand: 'lab-automation.md',
  LabProjectConversationResult: 'lab-automation.md',
  LabProjectStore: 'lab-automation.md',
  CreateLabProjectRequest: 'lab-automation.md',
  LabProjectView: 'lab-automation.md',
  CreateLabExperimentRequest: 'lab-automation.md',
  LabExperimentRecord: 'lab-automation.md',
  LinkLabExperimentSessionRequest: 'lab-automation.md',
  LabProjectId: 'lab-automation.md',
  UpdateLabProjectScopeRequest: 'lab-automation.md',
  AttachLabProjectSessionRequest: 'lab-automation.md',
  LabProjectSessionAttachResult: 'lab-automation.md',
  LabProjectContext: 'lab-automation.md',
  PublishLabProjectFactRequest: 'lab-automation.md',
  LabProjectEvidenceProjection: 'lab-automation.md',
  LabProjectAudit: 'lab-automation.md',
  LabProject: 'lab-automation.md',
  LabProjectServiceConfig: 'lab-automation.md',
  StartRunRequest: 'lab-automation.md',
  LabRunReport: 'lab-automation.md',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  // 实验类型由各自的 opt-in 包 README 负责，不归入核心子系统页面。
  LabDeviceProvider: 'packages/experimental/lab-device/README.md',
  DeviceView: 'packages/experimental/lab-device/README.md',
  DeviceOperationRequest: 'packages/experimental/lab-device/README.md',
  DeviceReceipt: 'packages/experimental/lab-device/README.md',
  KnowledgeProvider: 'packages/experimental/lab-knowledge/README.md',
  ImportDocumentRequest: 'packages/experimental/lab-knowledge/README.md',
  ImportDocumentResult: 'packages/experimental/lab-knowledge/README.md',
  ImportStatusResult: 'packages/experimental/lab-knowledge/README.md',
  KnowledgeSearchRequest: 'packages/experimental/lab-knowledge/README.md',
  KnowledgeSearchResult: 'packages/experimental/lab-knowledge/README.md',
  KnowledgeConflict: 'packages/experimental/lab-knowledge/README.md',
  RecordConflictRequest: 'packages/experimental/lab-knowledge/README.md',
  ConfirmFactRequest: 'packages/experimental/lab-knowledge/README.md',
  LabPlanningProvider: 'packages/experimental/lab-planning/README.md',
  PlanningContext: 'packages/experimental/lab-planning/README.md',
  PlanProposalInput: 'packages/experimental/lab-planning/README.md',
  PlanProposalResult: 'packages/experimental/lab-planning/README.md',
  LabRuntimeProvider: 'packages/experimental/lab-runtime/README.md',
  ApprovePlanRequest: 'packages/experimental/lab-runtime/README.md',
  RunView: 'packages/experimental/lab-runtime/README.md',
  LabSkillProvider: 'packages/experimental/lab-skill/README.md',
  LabOperationResource: 'packages/experimental/lab-skill/README.md',
  LabOperationResourceInput: 'packages/experimental/lab-skill/README.md',
  LabOperationResourceKind: 'packages/experimental/lab-skill/README.md',
  LabSkillDraft: 'packages/experimental/lab-skill/README.md',
  ...
  LabAgentExperimentCreateRequest: 'packages/experimental/lab-mvp-web/README.md',
  LabAgentExperimentProgress: 'packages/experimental/lab-mvp-web/README.md',
  ...
  KnowledgeDocumentVersionId: 'packages/experimental/lab-domain/README.md',
  PlanId: 'packages/experimental/lab-domain/README.md',
  RunId: 'packages/experimental/lab-domain/README.md',
  OperationId: 'packages/experimental/lab-domain/README.md',
  PlanStepId: 'packages/experimental/lab-domain/README.md',
  SkillRevisionId: 'packages/experimental/lab-domain/README.md',
  ExperimentRequest: 'packages/experimental/lab-domain/README.md',
  ExperimentPlan: 'packages/experimental/lab-domain/README.md',
